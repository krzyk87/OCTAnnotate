...
public:
  ...
  */
  enum LineStyle { lsNone        ///< data points are not connected with any lines (e.g. data only represented
                   ...
                   ,lsDiscontinuousLine ///< data points are connected by a straight line except when the data is discontinuous
                 };
  Q_ENUMS(LineStyle)
  /*!
...
protected:
  ...
  void getDiscontinuousLinePlotData(QVector<QPointF> *linePixelData, QVector<QCPData> *scatterData) const;

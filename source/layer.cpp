...
void Layer::copyAuto2ManualPoints(int bscanNumber)
{
    if (bscanNumber == -1){ // all B-scans
        this->points = this->pointsAuto;
    } else {    // selected B-scan
        this->points[bscanNumber] = this->pointsAuto[bscanNumber];
    }
}

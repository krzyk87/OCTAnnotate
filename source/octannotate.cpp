...
void OCTAnnotate::on_segmentationFinished()
{
    ui->statusBar->clearMessage();
    progressBar->setValue(100);
    progressBar->setVisible(false);

//    scan->setHasSegmentations(AUTO, true);
